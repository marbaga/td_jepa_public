...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname spr_walker_v10 --sweep_config sweep_spr_walker --sf_agent spr --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname spr_cheetah_v10 --sweep_config sweep_spr_cheetah --sf_agent spr --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname spr_quadruped_v10 --sweep_config sweep_spr_quadruped --sf_agent spr --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname spr_pointmass_v10 --sweep_config sweep_spr_pointmass --sf_agent spr --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname spr_multi_walker_v10 --sweep_config sweep_spr_walker --sf_agent spr-multi --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname spr_multi_cheetah_v10 --sweep_config sweep_spr_cheetah --sf_agent spr-multi --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname spr_multi_quadruped_v10 --sweep_config sweep_spr_quadruped --sf_agent spr-multi --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname spr_multi_pointmass_v10 --sweep_config sweep_spr_pointmass --sf_agent spr-multi --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname hilp_walker_v10 --sweep_config sweep_hilp_walker --sf_agent hilp --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname hilp_cheetah_v10 --sweep_config sweep_hilp_cheetah --sf_agent hilp --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname hilp_quadruped_v10 --sweep_config sweep_hilp_quadruped --sf_agent hilp --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname hilp_pointmass_v10 --sweep_config sweep_hilp_pointmass --sf_agent hilp --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname laplacian_walker_v10 --sweep_config sweep_laplacian_walker --sf_agent laplacian --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname laplacian_cheetah_v10 --sweep_config sweep_laplacian_cheetah --sf_agent laplacian --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname laplacian_quadruped_v10 --sweep_config sweep_laplacian_quadruped --sf_agent laplacian --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname laplacian_pointmass_v10 --sweep_config sweep_laplacian_pointmass --sf_agent laplacian --use_wandb

    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname icvf_walker_v10 --sweep_config sweep_hilp_walker --sf_agent icvf --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname icvf_cheetah_v10 --sweep_config sweep_hilp_cheetah --sf_agent icvf --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname icvf_quadruped_v10 --sweep_config sweep_hilp_quadruped --sf_agent icvf --use_wandb
    # uv run -m scripts.pixel.launch_sf_dmc --wandb_gname icvf_pointmass_v10 --sweep_config sweep_hilp_pointmass --sf_agent icvf --use_wandb
