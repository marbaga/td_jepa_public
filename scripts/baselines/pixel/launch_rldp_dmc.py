...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.pixel.launch_rldp_dmc --wandb_gname rldp_walker_v10 --sweep_config sweep_walker --use_wandb
    # uv run -m scripts.pixel.launch_rldp_dmc --wandb_gname rldp_cheetah_v10 --sweep_config sweep_cheetah --use_wandb
    # uv run -m scripts.pixel.launch_rldp_dmc --wandb_gname rldp_quadruped_v10 --sweep_config sweep_quadruped --use_wandb
    # uv run -m scripts.pixel.launch_rldp_dmc --wandb_gname rldp_pointmass_v10 --sweep_config sweep_pointmass --use_wandb
