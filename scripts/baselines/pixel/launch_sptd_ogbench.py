        ...
        "agent": {
            ...
            "model": {
                ...
                "archi": {
                    ...
                    "encoder": {"name": "BackwardArchi", "hidden_dim": 512, "hidden_layers": 4, "norm": True},
                    "rgb_encoder": {
                        "name": "drq",
                        "feature_dim": 256,
...
if __name__ == "__main__":
    ...
    # uv run -m scripts.pixel.launch_sptd_ogbench --wandb_gname sptd_antmaze_v10 --sweep_config antmaze_v40 --use_wandb
    # uv run -m scripts.pixel.launch_sptd_ogbench --wandb_gname sptd_cube_v20 --sweep_config cube_v40 --use_wandb
