...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.baselines.pixel.launch_rldp_ogbench --use_wandb --wandb_gname rldp_antmaze_pixel --data_path datasets --workdir_root results --sweep_config sweep_antmaze
    # uv run -m scripts.baselines.pixel.launch_rldp_ogbench --use_wandb --wandb_gname rldp_cube_pixel --data_path datasets --workdir_root results --sweep_config sweep_cube