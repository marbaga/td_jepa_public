...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.pixel.launch_rldp_ogbench --wandb_gname rldp_antmaze_v10 --sweep_config antmaze_v40 --use_wandb
    # uv run -m scripts.pixel.launch_rldp_ogbench --wandb_gname rldp_cube_v10 --sweep_config cube_v40 --use_wandb
