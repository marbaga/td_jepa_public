...
class LaunchArgs:
    ...
    left_encoder: Literal["none", "shallow", "deep"] = "deep"
...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.replearn.launch_sf_ogbench --wandb_gname spr_antmaze_v10 --sweep_config spr_antmaze_v40 --sf_agent spr --use_wandb
    # uv run -m scripts.replearn.launch_sf_ogbench --wandb_gname spr_multi_antmaze_v10 --sweep_config spr_antmaze_v40 --sf_agent spr-multi --use_wandb
    # uv run -m scripts.replearn.launch_sf_ogbench --wandb_gname hilp_antmaze_v10 --sweep_config hilp_antmaze_v40 --sf_agent hilp --use_wandb
    # uv run -m scripts.replearn.launch_sf_ogbench --wandb_gname laplacian_antmaze_v10 --sweep_config laplacian_antmaze_v40 --sf_agent laplacian --use_wandb

    # uv run -m scripts.replearn.launch_sf_ogbench --wandb_gname spr_cube_v10 --sweep_config spr_cube_v40 --sf_agent spr --use_wandb
    # uv run -m scripts.replearn.launch_sf_ogbench --wandb_gname spr_multi_cube_v10 --sweep_config spr_cube_v40 --sf_agent spr-multi --use_wandb
    # uv run -m scripts.replearn.launch_sf_ogbench --wandb_gname hilp_cube_v10 --sweep_config hilp_cube_v40 --sf_agent hilp --use_wandb
    # uv run -m scripts.replearn.launch_sf_ogbench --wandb_gname laplacian_cube_v10 --sweep_config laplacian_cube_v40 --sf_agent laplacian --use_wandb

    # uv run -m scripts.replearn.launch_sf_ogbench --wandb_gname icvf_antmaze_v10 --sweep_config hilp_antmaze_v40 --sf_agent icvf --use_wandb
    # uv run -m scripts.replearn.launch_sf_ogbench --wandb_gname icvf_cube_v10 --sweep_config hilp_cube_v40 --sf_agent icvf --use_wandb
