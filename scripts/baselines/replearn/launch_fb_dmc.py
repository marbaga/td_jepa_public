...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.replearn.launch_fb_dmc --wandb_gname fb_walker_v10 --sweep_config sweep_walker --use_wandb
    # uv run -m scripts.replearn.launch_fb_dmc --wandb_gname fb_cheetah_v10 --sweep_config sweep_cheetah --use_wandb
    # uv run -m scripts.replearn.launch_fb_dmc --wandb_gname fb_quadruped_v10 --sweep_config sweep_quadruped --use_wandb
    # uv run -m scripts.replearn.launch_fb_dmc --wandb_gname fb_pointmass_v10 --sweep_config sweep_pointmass --use_wandb
