    ...
    base_config.update(
        {
            "data": {
                "name": "dmc",
                "dataset_root": data_paths["url_data_root_path_pixels"],
                "domain": "walker",
...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.replearn.pixel.launch_td_jepa_dmc --wandb_gname td_jepa_walker --sweep_config sweep_walker --use_wandb
    # uv run -m scripts.replearn.pixel.launch_td_jepa_dmc --wandb_gname td_jepa_cheetah --sweep_config sweep_cheetah --use_wandb
    # uv run -m scripts.replearn.pixel.launch_td_jepa_dmc --wandb_gname td_jepa_quadruped --sweep_config sweep_quadruped --use_wandb
    # uv run -m scripts.replearn.pixel.launch_td_jepa_dmc --wandb_gname td_jepa_pointmass --sweep_config sweep_pointmass --use_wandb
