...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.replearn.proprio.launch_td_jepa_ogbench --wandb_gname td_jepa_antmaze --sweep_config sweep_antmaze --use_wandb
    # uv run -m scripts.replearn.proprio.launch_td_jepa_ogbench --wandb_gname td_jepa_cube --sweep_config sweep_cube --use_wandb
