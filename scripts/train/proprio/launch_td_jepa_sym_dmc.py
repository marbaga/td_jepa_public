...
if __name__ == "__main__":
    ...
    main(args)
    # uv run -m scripts.train.proprio.launch_td_jepa_sym_dmc --use_wandb --wandb_gname td_jepa_sym_walker_proprio --data_path datasets --workdir_root results --sweep_config sweep_walker
    # uv run -m scripts.train.proprio.launch_td_jepa_sym_dmc --use_wandb --wandb_gname td_jepa_sym_cheetah_proprio --data_path datasets --workdir_root results --sweep_config sweep_cheetah
    # uv run -m scripts.train.proprio.launch_td_jepa_sym_dmc --use_wandb --wandb_gname td_jepa_sym_quadruped_proprio --data_path datasets --workdir_root results --sweep_config sweep_quadruped
    # uv run -m scripts.train.proprio.launch_td_jepa_sym_dmc --use_wandb --wandb_gname td_jepa_sym_pointmass_proprio --data_path datasets --workdir_root results --sweep_config sweep_pointmass
